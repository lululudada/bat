...
"模仿下列标题：LINGLUCKY Tocador de Maquillaje con Espejo Luz LED,Escon estación de Carga, Taburete Tapizado,Tocador Vanity 2 Cajones Grande,Mueble para Maquillaje Minimalista,Tocador Moderno y de Lujo,Blanco根据图片生成新的标题"
"4. 字符数不超过400；"
